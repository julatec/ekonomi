...
@Adapt({
        ...
        cr.go.hacienda.tribunet.v44.factura.FacturaElectronica.InformacionReferencia.class,
        cr.go.hacienda.tribunet.v44.factura.compra.FacturaElectronicaCompra.InformacionReferencia.class,
        cr.go.hacienda.tribunet.v44.factura.exportacion.FacturaElectronicaExportacion.InformacionReferencia.class,
        cr.go.hacienda.tribunet.v44.tiquete.TiqueteElectronico.InformacionReferencia.class,
        cr.go.hacienda.tribunet.v44.nota.credito.NotaCreditoElectronica.InformacionReferencia.class,
        cr.go.hacienda.tribunet.v44.nota.debito.NotaDebitoElectronica.InformacionReferencia.class,
})
