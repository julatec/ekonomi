...
public class NotaCredito implements ElectronicReceipt {

    public static final String EXPORT_NAME = "notaCredito";
    ...
    private final Record.Key key = new Record.Key(
            ...
            () -> documento.getResumen().getTotalComprobante().negate(),
    ...
    public NotaCredito setClaveNota(ClaveNota claveNota) {
    ...
    public NotaCredito setDocumento(Documento documento) {
