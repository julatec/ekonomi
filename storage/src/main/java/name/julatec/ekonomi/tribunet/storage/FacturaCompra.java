...
public class FacturaCompra implements ElectronicReceipt {

    private static final Currency CURRENCY = Currency.getInstance(Locale.getDefault());
    public static final String EXPORT_NAME = "factura_compra";
    ...
    public FacturaCompra setClave(String clave) {
        this.clave = clave;
        return this;
    }
    ...
    public FacturaCompra setNumeroConsecutivo(String numeroConsecutivo) {
    ...
    public FacturaCompra setDocumento(Documento documento) {
    ...
    public boolean equals(Object o) {
        ...
        FacturaCompra factura = (FacturaCompra) o;
